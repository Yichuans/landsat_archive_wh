...
def rename_jpegs(folder):
    for filename in os.listdir(folder):
        if filename.endswith('.jpg'):
            landsat8 = landsat_scene(filename.split('_')[0])
            newfilename =  landsat8.wrspath + landsat8.wrsrow + '_' + landsat8.date_text() + '.jpg'
            os.rename(folder + os.sep + filename, folder + os.sep + newfilename)
